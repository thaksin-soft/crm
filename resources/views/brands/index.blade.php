        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="bg-white border-b border-gray-200 mt-3 lao-font py-8">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <form method="POST" action="{{ route('pro-brands.store') }}" id="form-brand">
                                @csrf
                                ...
                                <div>
                                    ...
                                    <x-input id="brand_code" class="form-control" type="text" name="brand_code"
                                        :value="old('brand_code')" required autofocus placeholder="..." />
                                </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-input id="brand_name" class="form-control" type="text" name="brand_name"
                                        :value="old('brand_name')" required autofocus placeholder="..." />
                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="#" class="text-warning" data-toggle="modal"
                                                    ...
                                                    onclick="set_edit_brand({{ $item->id }}, '{{ $item->code }}', 
                                                    '{{ $item->brand_name }}', '{{ $item->code_fb }}', '{{ $item->from_base }}')"><i
                                                        class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                            </td>
                                            <td class="text-center">
                                                <a href="#" class="text-danger"
                                                    onclick="delete_brands({{ $item->id }})"><i
                ...
                <div class="modal-body lao-font">
                    <form method="POST" action="" id="form-edit-brand">
                        ...
                        <div class="mt-4">
                            ...
                            <x-input class="form-control" type="text" name="edit_brand_name"
                                :value="old('edit_brand_name')" required autofocus placeholder="..." />
                        </div>
...
<script>
    ...
    function load_fb_odien() {
        $.ajax({
            type: "GET",
            url: "{{ Route('fetch-brand-fb-odien') }}",
            success: function(e) {
                //console.log(e);
                $("#fb-odien-table").html('');
                $.each(e, function(i, item) {
