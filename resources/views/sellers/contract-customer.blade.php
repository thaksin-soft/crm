                        ...
                        <form action="{{ route('save-contract-customer') }}" method="POST"
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody id="product-table">
                                            @foreach ($interest_pro as $pro_key => $product_item)
                                                <tr>
                                                    <td>{{ $product_item->cus_interest_product }}<input type="hidden"
                                                    ...
                                                    <td>{{ $product_item->pr_size }}<input type="hidden"
                                                            name="txt_size[]" value="{{ $product_item->pr_size }}">
                                                    </td>
                                                </tr>
                                            @endforeach
                            ...
                            <div class="row">
                                <div class="col-md-12" style="padding-right: 12%; padding-left: 10%">
                                    ...
                                    <button class="btn btn-warning" type="button" onclick="waiting_desides()"><i
                                            class="fa fa-check" aria-hidden="true"></i>
                                        ລໍຖ້າຕັດສິນໃຈ</button>
