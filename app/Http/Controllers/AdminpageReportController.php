...
class AdminpageReportController extends Controller
{
    public function report_track_movement(Request $request)
    {
        ...
        ->paginate(10);
        return view('reports.adminpage.report-movement-sale', compact('data', 'set_month', 'set_year'));
    }
    ...
    public function report_seller_nocontrack(Request $request)
    {
        ...
        $data = TrackOnline::whereMonth('crm_track_online.created_at', $set_month)
        ->join('crm_employee', 'crm_employee.id', 'crm_track_online.emp_id')
        ...
        ->paginate(10);
        return view('reports.adminpage.report-seller-nocontract', compact('data', 'set_month', 'set_year'));
    }
    ...
    public function report_cus_purchased(Request $request)
    {
        ...
        ->paginate(10);
        return view('reports.adminpage.report-cus-purchased', compact('data', 'set_month', 'set_year'));
    }
}